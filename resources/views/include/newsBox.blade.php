<div class=" mt-10 lg:m-0 group border max-w-sm text-center overflow-hidden border-gray-200">     
        <div class="overflow-hidden w-[90%] mx-auto max-h-[170px] relative">
            ...
            <div class="flex items-center justify-center absolute transition duration-500 scale-0 bg-pallette-light-blue opacity-90 top-0 right-0 h-full w-full group-hover:scale-100">
