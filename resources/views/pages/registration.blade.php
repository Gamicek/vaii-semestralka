...
<section>
     <div class="flex items-center justify-center h-screen bg-gray-100">
        <form action="{{ route('fe-pages.registration.create') }}" method="GET">
            ...
            <div class="bg-gray-200 w-96 p-6 rounded shadow-sm">
                ...
                <input name="name" value="{{old('name')}}" class="w-full py-2 bg-gray-50 text-pallette-text-gray px-1 outline-none mb-4" type="name" id="grid-first-name" placeholder="Your Full name"> 
