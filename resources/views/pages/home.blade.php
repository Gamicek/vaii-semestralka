...
<section class="mt-16 relative h-[540px] flex items-center justify-center">
    
        <img class=" absolute top-0 left-0" src="{{asset('img/slider1.jpg')}}" alt="fotka">
        <div class="max-w-[1500px] mx-auto flex justify-start w-[1500px]">

            <div class=" z-10">
    
                <h3 class=" text-6xl font-bold font-serif">We can fix it broken <br>mobile glass</h3>
                ...
                <button class=" transition duration-300 shadow bg-blue-400 hover:bg-blue-600 focus:shadow-outline focus:outline-none border-2 border-transparent hover:border-blue-400 text-white font-bold py-2 px-4 mt-10 mr-2 " type="button">
                    Kúpiť
                </button>
    
                <button class=" transition duration-300 shadow bg-blue-600 hover:bg-blue-400 focus:shadow-outline focus:outline-none border-2 border-transparent hover:border-blue-600 text-white font-bold py-2 px-4 " type="button">
                    Kontaktovať
                </button>
            </div>
        </div>
...
<section class="pt-16 bg-cover bg-no-repeat bg-center categories-bg bg-fixed">
    ...
    <h2 class="text-center uppercase text-white text-5xl font-bold ">Kategórie</h2>

    <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-3 max-w-[1300px] mx-auto py-16 ml-10">
...
<section class="bg-white  ">
    <h2 class="text-4xl font-bold text-center mt-10">Najnovšie správy</h2>
    <div class="grid lg:grid-cols-3 md:grid-cols-2 max-w-[1300px] mx-auto p-9">
